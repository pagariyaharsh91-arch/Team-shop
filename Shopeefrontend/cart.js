...
function render() {
  ...
  container.innerHTML = cart
    .map((it, idx) => {
      ...
      const image = it.image || "images/products/placeholder.jpg";
      ...
      <div style="background:#fff;border:1px solid #eee;border-radius:14px;padding:14px;margin-bottom:12px;">
        ...
        <div style="display:flex;justify-content:space-between;gap:14px;flex-wrap:wrap;">
          ...
          <div style="display:flex;gap:12px;align-items:center;">
            ...
            <img src="${image}" style="width:60px;height:60px;object-fit:contain;border-radius:8px;background:#f5f5f5;">
          ...
          <div class="cart-controls">
            ...
            <button type="button" class="qty-btn" onclick="decQty(${idx})">-</button>
            ...
            <button type="button" class="qty-btn" onclick="incQty(${idx})">+</button>
            
            <button type="button" class="remove-btn" onclick="removeItem(${idx})">Remove</button>
  ...
  setText(
    "delivery-charge",
    t.deliveryCharge === 0 ? "FREE" : `₹${t.deliveryCharge.toFixed(2)}`
  );
  ...
  if (msg)
    msg.textContent =
      t.subtotal >= 500
        ...
        : `Add ₹${Math.ceil(500 - t.subtotal)} more for FREE delivery`;
...
window.setQty = function (idx, value) {
  const cart = getCart();
